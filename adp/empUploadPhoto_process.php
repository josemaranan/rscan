...
if(isset($_POST['Submit'])) 
 {
 	...
 	if ($image) 
 	{
 		...
 		if (($extension != "jpg") && ($extension != "jpeg") && ($extension != "png") && ($extension != "gif")) 
 		{
			...
			header("Location: index.php?hdnEmployeeID=".$employeeID."&adpMode=hr&adpTask=empUploadPhoto&error=ErrUpload1&activeLink=");
			exit;
 		...
 		else
 		{
			...
			if ($size > MAX_SIZE*1024)
			{
				...
				$errors=1;
				header("Location: index.php?hdnEmployeeID=".$employeeID."&adpMode=hr&adpTask=empUploadPhoto&error=ErrUpload2&activeLink=");
				exit;
		...
		if (!$copied) 
		{
			...
			$errors=1;
			header("Location: index.php?hdnEmployeeID=".$employeeID."&adpMode=hr&adpTask=empUploadPhoto&error=ErrUpload3&activeLink=");
			exit;
		}
...
{
	header("Location: index.php?hdnEmployeeID=".$employeeID."&adpMode=hr&adpTask=empUploadPhoto&error=DataIUpdate&activeLink=");
	exit;
}
?>