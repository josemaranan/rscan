...
// form starts here
$htmlForm->action = 'add_salary_process.php';
...
else
{
	...
	$htmlTextElement->value = $todayDate;
...
$txaReason = $htmlTagObj->textAreatag('rows="4" cols="50" id="txaReason" name="txaReason" ', '');
...
if($lockallFields)
{
	echo $htmlTagObj->openTag('div','style="width:28%; float:left; margin:0px; padding:0px; text-align:left;"');
	echo $htmlTagObj->openTag('table');
	echo $htmlTagObj->openTag('tr');
    echo $htmlTagObj->openTag('td');
	echo $htmlTagObj->openTag('div','style="width:90%; padding:5px; font-size:12px; color:#F00; text-align:left;"');
