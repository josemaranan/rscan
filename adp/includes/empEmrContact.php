...
$htmlForm->action = 'employeeEmergencyInfo_process.php';
...
$emptyData			= $htmlTextElement->addLabel($emptyData, '', '','');
$txtEmEffecDate		= $htmlTextElement->addLabel($txtEmEffecDate, 'Effective Date', '#ff0000','');
$txtEmFirstName		= $htmlTextElement->addLabel($txtEmFirstName, 'First Name', '#ff0000',true);
$txtEmLastName		= $htmlTextElement->addLabel($txtEmLastName, 'Last Name', '#ff0000',true);
