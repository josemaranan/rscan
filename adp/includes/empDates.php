...
$Row->Cells["Column7"]->Value="Last Day Worked";
$Row->Cells["Column8"]->Value="Term Reason";
$Row->Cells["Column9"]->Value="Can Be Rehired?";
$Row->Cells["Column10"]->Value="Voluntary Termination";
$Row->Cells["Column11"]->Value="Notes";
$Row->Cells["Column12"]->Value="Modified By";
$Row->Cells["Column13"]->Value="Modified Date";
...
foreach($employmentDatesArray as $mainArrayK => $mainArrayV) 
{
	...
	if(!empty($mainArrayV['lastDayWorked'])) 
	{
		$lastDayWorked = date('m/d/Y',strtotime($mainArrayV['lastDayWorked']));
	}
	else
	{
		$lastDayWorked = '';
	...
	$Row->Cells["Column7"]->Value = !empty($lastDayWorked) ? $lastDayWorked : '&nbsp;';
	$Row->Cells["Column8"]->Value = !empty($terminationReason) ? $terminationReason : '&nbsp;';
	$Row->Cells["Column9"]->Value = !empty($canBeRehired) ? $canBeRehired : '&nbsp;';
	$Row->Cells["Column10"]->Value = !empty($voluntaryTermination) ? $voluntaryTermination : '&nbsp;';
	$Row->Cells["Column10"]->Value = !empty($notes) ? wordwrap($notes,200,"<br />\n") : '&nbsp;';
	$Row->Cells["Column12"]->Value = !empty($modifiedBy) ? $modifiedBy : '&nbsp;';
	$Row->Cells["Column13"]->Value = !empty($modifiedDate) ? $modifiedDate : '&nbsp;';
	//*/
	$i++;
}
