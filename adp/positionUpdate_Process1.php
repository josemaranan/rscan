...
//---------------------End of Newly Added by Murali as per task # 7125-----------------------------------
	...
	if($positionID==132 || $positionID==47 || $positionID==357 || $positionID==322)
	{
	...
	if($positionID==30 || $positionID==132 || $positionID==47 || $positionID==356 || $positionID==357 || $positionID==322)
	{
