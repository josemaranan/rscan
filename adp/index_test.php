...
switch($adpTask)
{
	case 'empModifyContractor':
		...
		$includeString = 'include_once(\'includes/empModifyContractor_RDS.php\');';   ////
		$pageTitle = 'RNet - ADP Payroll - Modify Contractor';
		$bottomLinkFlag = true;
	    break;
	
	case 'empManagement':
		$includeString = 'include_once(\'includes/empManagement_RDS.php\');';////
		$pageTitle = 'ReadiNet - ADP Payroll - Employee Management';
		break;
	
	case 'empDetails':
		$includeString = 'include_once(\'includes/empDetails_RDS.php\');';////
		$bottomLinkFlag = true;
		$pageTitle = 'ReadiNet - ADP Payroll - Employee Details';
		break;
	
	case 'empDates':
		$includeString = 'include_once(\'includes/empDates_RDS.php\');';  ////
		$bottomLinkFlag = true;
		$pageTitle = 'ReadiNet - ADP Payroll - Employee Dates';
		break;
	
	case 'empDatesAdd':
		$includeString = 'include_once(\'includes/empDatesAdd_RDS.php\');';
		$bottomLinkFlag = true;
	...
	case 'empDatesEdit':
		...
		$includeString = 'include_once(\'includes/empDatesEdit_RDS.php\');';
		break;
	
	case 'empFullTime':
		$bottomLinkFlag = true;
		$pageTitle = 'ReadiNet - ADP Payroll - Employee Part Time / Full Time';
		$includeString = 'include_once(\'includes/empFullTime_RDS.php\');';
		break;
	
	case 'empFullTimeEdit':
		$bottomLinkFlag = true;
		$pageTitle = 'ReadiNet - ADP Payroll - Employee Part Time / Full Time - Edit';
		$includeString = 'include_once(\'includes/empFullTimeEdit_RDS.php\');';
		break;
	...
	case 'empPosition':
		...
		$includeString = 'include_once(\'includes/empPosition_RDS.php\');';
	...
	case 'empPayrollData':
		...
		$includeString = 'include_once(\'includes/empPayrollData_RDS.php\');';  ////
		break;
	...
	case 'empClient':
		...
		$includeString = 'include_once(\'includes/empClient_RDS.php\');';  ////
		break;
	...
	case 'empAddress':
		...
		$scrollingSyle = 'style="display:none;"';
		$pageTitle = 'ReadiNet - ADP Payroll - Employee Client';
		$includeString = 'include_once(\'includes/empAddress_RDS.php\');';  ////
		break;
	...
	case 'empPersonalInfo':
		...
		$includeString = 'include_once(\'includes/empPersonalInfo_RDS.php\');';  ////
		break;
	...
	case 'empSalary':
		...
		$includeString = 'include_once(\'includes/empSalary_RDS.php\');';   ////
		break;
	...
	case 'empEmrContact':
		...
		$scrollingSyle = 'style="display:none;"';
		$pageTitle = 'ReadiNet - ADP Payroll - Add Employee Salary Information';
		$includeString = 'include_once(\'includes/empEmrContact_RDS.php\');';   ////
		break;
	...
	case 'empUploadPhoto':
		...
		$includeString = 'include_once(\'includes/empUploadPhoto_RDS.php\');';  ////
		$bottomLinkFlag = true;
		break;
	
	case 'empRemoval':
		$pageTitle = 'ReadiNet - ADP Payroll - Remove Employee Records';
		$includeString = 'include_once(\'includes/empRemoval_RDS.php\');';
		$bottomLinkFlag = true;
		break;
	...
	case 'empSupervisor':
		...
		$scrollingSyle = 'style="display:none;"';
		$pageTitle = 'ReadiNet - ADP Payroll - Employee Client';
		$includeString = 'include_once(\'includes/empSupervisor_RDS.php\');';
		break;
	/////////////////Work Item #38193
...
$cssFiles  = array( '/Include/CSS/jquery-ui-1.10.3.custom.css');
$jsFiles   = array('RNetIncludes/js/jquery-1.10.2.js', 'RNetIncludes/js/jquery-ui.min.js');
