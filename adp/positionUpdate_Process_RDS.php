...
global $db1;*/		
	...
	if($num3 == 0)
	{
		...
		$query = "Insert into ctlEmployeePositions(employeeID,positionID,effectiveDate,isPrimary,modifiedBy,modifiedDate) values(".$employeeID.",'".$jobcode."' , '".$effectiveDate."','".$isPrimary."','".$_SESSION[empID]."' , '".date("m/d/Y")."')";
...
if($jobcode==30 || $jobcode==132 || $jobcode==47)
{
