...
if(isset($_REQUEST['error']))
{
	...
	if($errorMessage == 'AddSalarySuccess' || $errorMessage == 'EditSalarySucess')
	{
		...
		$width = 430;
		$message = $message.'<br/>You have updated the pay rate in a previously finalized pay period. These changes need to be pushed to ADP';
		$width = 630;
		if($changeReason == 'Y')
		{				
			$message = $message.'<br/><img src="/Include/images/progress.gif" style="vertical-align:middle;"> &nbsp; ADPC file is generating.';	
		}
	?>
		<script type="text/javascript">
