...
if($rstDQry)
{
	...
	if(!$fromPage)
	{
		...
		{
		header("Location: index_test.php?hdnEmployeeID=".$employeeID."&adpMode=emp&adpTask=empPersonalInfo&error=PersonalInfoSucess&activeLink=20");
		}
	}
	else
	{
			header("Location: index_test.php?hdnEmployeeID=".$employeeID."&adpMode=emp&adpTask=empViewPersonalInfo&error=PersonalInfoSucess&activeLink=20");
	}
