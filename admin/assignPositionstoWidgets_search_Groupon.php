...
$wfQuery = " SELECT positionID , CONVERT(VARCHAR(10), positionID)+'-'+position positionVal FROM Results.dbo.ctlPositions (NOLOCK) WHERE active = 'Y' AND positionID IN (10,314,356,308) ORDER BY positionID ";
$commonListBox->sqlQry = $wfQuery;
