...
if(isset($_POST['Update']))
{
	...
	$queryUpdate = " BEGIN TRANSACTION CostSummary 
					UPDATE common..prm_rnet_CostSummaryBySite SET
									payableHours = $payableHours,
									agentRegularPay = $agentRegularPay,
									agentOTPay = $agentOTPay,
									agentTrainingPay = $agentTrainingPay,
									agentBonusPay = $agentBonusPay,
									agentIncentivePay = $agentIncentivePay,
									directLaborRegularPay =	$directLaborRegularPay,
									directLaborOTPay = $directLaborOTPay,
									directLaborTrainingPay = $directLaborTrainingPay,
									directLaborBonusPay = $directLaborBonusPay,
									directLaborIncentivePay = $directLaborIncentivePay,
									adminRegularPay = $adminRegularPay,
									adminOTPay = $adminOTPay,
									adminTrainingPay = $adminTrainingPay,
									adminBonusPay = $adminBonusPay,
									adminIncentivePay = $adminIncentivePay,
									fixedFacilityCost = $fixedFacilityCost,
									variableFacilityCost = $variableFacilityCost,
									pointToPointCost = $pointToPointCost,
									directTelecomCost = $directTelecomCost,
									ownershipMarginTier1 = $ownershipMarginTier1,
									ownershipMarginTier2 = $ownershipMarginTier2,
          		...
          		END 														
					...
					UPDATE common..prm_rnet_CostSummaryBySite SET
									payableHours = $payableHours1,
									agentRegularPay = $agentRegularPay1,
									agentOTPay = $agentOTPay1,
									agentTrainingPay = $agentTrainingPay1,
									agentBonusPay = $agentBonusPay1,
									agentIncentivePay = $agentIncentivePay1,
									directLaborRegularPay =	$directLaborRegularPay1,
									directLaborOTPay = $directLaborOTPay1,
									directLaborTrainingPay = $directLaborTrainingPay1,
									directLaborBonusPay = $directLaborBonusPay1,
									directLaborIncentivePay = $directLaborIncentivePay1,
									adminRegularPay = $adminRegularPay1,
									adminOTPay = $adminOTPay1,
									adminTrainingPay = $adminTrainingPay1,
									adminBonusPay = $adminBonusPay1,
									adminIncentivePay = $adminIncentivePay1,
									fixedFacilityCost = $fixedFacilityCost1,
									variableFacilityCost = $variableFacilityCost1,
									pointToPointCost = $pointToPointCost1,
									directTelecomCost = $directTelecomCost1,
									ownershipMarginTier1 = $ownershipMarginTier11,
									ownershipMarginTier2 = $ownershipMarginTier21,
									modifiedBy = '$modifiedBy',
									modifiedDate = '$modifiedDate'
									WHERE
									location = '".$loc."' 
		...
		mssql_query(str_replace("\'","''",$queryUpdate), $db);
...
//---  GETTING FORECASTED
	...
	$queryForecats = "SELECT * FROM COMMON.dbo.prm_rnet_CostSummaryBySite 
					  WHERE 
					  		location = '".$loc."' 
							AND
							currentYear = '".$Year."'
		...
		$rstForecats=mssql_query(str_replace("\'","''",$queryForecats), $db);
		
			while ($rowFC=mssql_fetch_array($rstForecats)) 
	 		{
			
				$payableHours = $rowFC[payableHours];
				$agentRegularPay = $rowFC[agentRegularPay];
				$agentOTPay = $rowFC[agentOTPay];
				$agentTrainingPay = $rowFC[agentTrainingPay];
				$agentBonusPay = $rowFC[agentBonusPay];
				$agentIncentivePay = $rowFC[agentIncentivePay];
				$directLaborRegularPay = $rowFC[directLaborRegularPay];
				$directLaborOTPay = $rowFC[directLaborOTPay];
				$directLaborTrainingPay = $rowFC[directLaborTrainingPay];
				$directLaborBonusPay = $rowFC[directLaborBonusPay];
				$directLaborIncentivePay = $rowFC[directLaborIncentivePay];
				$adminRegularPay = $rowFC[adminRegularPay];
				$adminOTPay = $rowFC[adminOTPay];
				$adminTrainingPay = $rowFC[adminTrainingPay];
				$adminBonusPay = $rowFC[adminBonusPay];
				$adminIncentivePay = $rowFC[adminIncentivePay];
				$fixedFacilityCost = $rowFC[fixedFacilityCost];
				$variableFacilityCost = $rowFC[variableFacilityCost];
				$pointToPointCost = $rowFC[pointToPointCost];
				$directTelecomCost = $rowFC[directTelecomCost];
				$ownershipMarginTier1 = $rowFC[ownershipMarginTier1];
				$ownershipMarginTier2 = $rowFC[ownershipMarginTier2];
			}
///FORE CASTED DATA END
...
//GETTING ACTUAL DATA
	...
	$queryActual = "SELECT * FROM COMMON.dbo.prm_rnet_CostSummaryBySite 
					  WHERE 
					  		location = '".$loc."' 
							AND
							currentYear = '".$Year."'
		...
		$rstActual=mssql_query(str_replace("\'","''",$queryActual), $db);
		
			while ($rowAC=mssql_fetch_array($rstActual)) 
	 		{
				$payableHours1 = $rowAC[payableHours];
				$agentRegularPay1 = $rowAC[agentRegularPay];
				$agentOTPay1 = $rowAC[agentOTPay];
				$agentTrainingPay1 = $rowAC[agentTrainingPay];
				$agentBonusPay1 = $rowAC[agentBonusPay];
				$agentIncentivePay1 = $rowAC[agentIncentivePay];
				$directLaborRegularPay1 = $rowAC[directLaborRegularPay];
				$directLaborOTPay1 = $rowAC[directLaborOTPay];
				$directLaborTrainingPay1 = $rowAC[directLaborTrainingPay];
				$directLaborBonusPay1 = $rowAC[directLaborBonusPay];
				$directLaborIncentivePay1 = $rowAC[directLaborIncentivePay];
				$adminRegularPay1 = $rowAC[adminRegularPay];
				$adminOTPay1 = $rowAC[adminOTPay];
				$adminTrainingPay1 = $rowAC[adminTrainingPay];
				$adminBonusPay1 = $rowAC[adminBonusPay];
				$adminIncentivePay1 = $rowAC[adminIncentivePay];
				$fixedFacilityCost1 = $rowAC[fixedFacilityCost];
				$variableFacilityCost1 = $rowAC[variableFacilityCost];
				$pointToPointCost1 = $rowAC[pointToPointCost];
				$directTelecomCost1 = $rowAC[directTelecomCost];
				$ownershipMarginTier11 = $rowAC[ownershipMarginTier1];
				$ownershipMarginTier21 = $rowAC[ownershipMarginTier2];
...
<input type="hidden" name="monthDesc" id="monthDesc" value="<?=$monthDesc?>" />
 ...
 <tr>
	  ...
	  <tr>
		...
		<input type="submit" value="Update" name="Update" id="Update" onclick="return Validate()" />
