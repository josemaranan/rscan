...
echo '<iframe height="300px" width="500px" class="videobox" id="videobox" src="http://asg.idomoo.com/iframe_content.html?id='.$vid.'" frameborder="0" allowfullscreen=""></iframe>';
...
echo '<td class="frmTableTD">';
//echo $ddlDays;
echo '<input type="text" name="phone" id="phone" value="mm/dd/2014">';
echo '</td>';
echo '<td class="frmTableTD">';
echo $ddlTime;
echo '</td>';
