...
$cssJsArray = array('CSS'=>array('Tabstyles.css' , 'readiNetAll.css', 'agentScore.css' ), 'JS'=>array('table.js','agentScoreCard/jquery.min.js',  'agentScoreCard/tytabs.jquery.min.js' ,  'agentScoreCard/scoreCaredLifeCycle.js'));
...
$htmlObject->loadBodyTag('leftMenu','No',array('style'=>'background-color:#000'));
...
<div id="mainSubContent">
    ...
    <div id="empNames">Name: <?php echo $employeeNameAndAvaya[0]['employeeName'];?> &nbsp;&nbsp;&nbsp;&nbsp; Avaya ID(s): <?php echo $employeeNameAndAvaya[0]['avayaIDs'];?></div>
        ...
        <ul class="tabs">
            <li id="tab1" onclick="return makeItDynamic(); return false;">Lifecycle</li>
            <li id="tab2" onclick="return makeItDynamic(); return false;" >Employee Training History</li>
            <li id="tab3" onclick="return makeItDynamic(); return false;">Reporting Structure History</li>
        </ul>
           ...
           <table border="0"  bgcolor="#FFFFFF" cellspacing="0" class="report" id="tTraining">
            <thead>
              <tr>
                ...
                <th align="center"><strong>Training Description</strong></th>
			...
			if(!empty($getEmployeeLifeCycleData))
			{
                ...
                <td style="text-align:left;"><?php echo $getEmployeeLifeCycleDataVal['trainingType'];?></td>
				 ...
				 if(!empty($getEmployeeLifeCycleDataVal['trainingDescription']))
				{
				 	echo $getEmployeeLifeCycleDataVal['trainingDescription'];
				}
				else
				{
					echo '&nbsp';
        ...
        <?php
			if(!empty($getEmployeeStrucrureData))
			{
                ...
                <td style="text-align:center;"><?php echo $getEmployeeStrucrureDataVal['employeeCumulativeTenure'];?>&nbsp;days</td>
