...
<tr>
    ...
    <th class="ColumnHeader1">CSAT Goal</th>
    ...
    <?php } ?>
    <th class="ColumnHeader1"># Surveys</th>
    <th class="ColumnHeader1">CSAT %</th>
    
    <th class="ColumnHeader1">% Highly <br />Satisfied</th>
    <th class="ColumnHeader1">% Satisfied</th>
    <th class="ColumnHeader1">% Neutral </th>
    <th class="ColumnHeader1">% Dissatisfied</th>
    <th class="ColumnHeader1">% Highly <br />Dissatisfied</th>
		...
		if(!empty($requiredData))
		{
			...
			{ 
				...
				?>
							...
							if($requiredDataVal['CSAT Goal']!='%')
							{
								$agentScoreObj->numberFormat($requiredDataVal['CSAT Goal']);
							}
							...
							{?>
                                ...
                                <img src="includes/images/pie_chart.png" border="0" style="width:20px; height:20px; cursor:hand;" title="Click here to view chart" onclick="return populateDetails('<?php echo $type;?>', '<?php echo $measure;?>' , '<?php echo $period;?>' , '<?php echo $employeID;?>', '<?php echo $startDate;?>' , '<?php echo $endDate;?>' , 'dataPie' , '<?php echo $requiredDataVal['LOB'];?>' ); return false;"/>
                                         
                                <?php }
                                else if ($requiredDataVal['Date']=='Subtotals')
                                { ?>
                                
                                <img src="includes/images/bar_graph.png" border="0" style="width:20px; height:20px; cursor:hand;" title="Click here to view chart" onclick="return populateDetails('<?php echo $type;?>', '<?php echo $measure;?>' , '<?php echo $period;?>' , '<?php echo $employeID;?>', '<?php echo $startDate;?>' , '<?php echo $endDate;?>' , 'data', '<?php echo $requiredDataVal['LOB'];?>' ); return false;"/>
                                    
                                <?php } else { echo '&nbsp;'; } ?>
                                </td>
                            <?php } ?>
							<td style="text-align:center;"><?php 
							if(!empty($requiredDataVal['Number of Surveys']))
							{
								echo $requiredDataVal['Number of Surveys'];
							}
							else
							{	
								echo '&nbsp;';
								...
								?></td>
							<td style="text-align:center;"><?php 
								if(!empty($requiredDataVal['CSAT Score']))
								{
									$agentScoreObj->numberFormat($requiredDataVal['CSAT Score']);
								}
								else
								{
									echo '&nbsp;';	
							...
							<td style="text-align:center;"><?php 
								if(!empty($requiredDataVal['Highly Satisfied']))
								{
									$agentScoreObj->numberFormat($requiredDataVal['Highly Satisfied']);
								}
								else
								{
									echo '&nbsp;';	
							...
							?></td>
							<td style="text-align:center;"><?php 
							if(!empty($requiredDataVal['Satisfied']))
							{
								$agentScoreObj->numberFormat($requiredDataVal['Satisfied']);
							}
							else
							{
									echo '&nbsp;';	
							...
							?></td>
							<td style="text-align:center;"><?php 
							if(!empty($requiredDataVal['Neutral']))
							{
								$agentScoreObj->numberFormat($requiredDataVal['Neutral']);
							}
							else
							{
									echo '&nbsp;';	
							...
							?></td>
							<td style="text-align:center;"><?php 
							if(!empty($requiredDataVal['Dissatisfied']))
							{
								$agentScoreObj->numberFormat($requiredDataVal['Dissatisfied']);
							}
							else
							{
									echo '&nbsp;';	
							...
							?></td>
                            <td style="text-align:center;"><?php 
							if(!empty($requiredDataVal['Highly Dissatisfied']))
							{
								$agentScoreObj->numberFormat($requiredDataVal['Highly Dissatisfied']);
							}
							else
							{
									echo '&nbsp;';	
