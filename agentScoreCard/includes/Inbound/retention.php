...
<tr>
    <th class="ColumnHeader1 locked">LOB Name</th>
       <th class="ColumnHeader1">Retention Goal</th>
    ...
    <?php } ?>
    <th class="ColumnHeader1">Disenrollment <br />Requests</th>
    <th class="ColumnHeader1">Saves</th>
    <th class="ColumnHeader1">Missed Saves</th>
    <th class="ColumnHeader1">Retention %</th>
		...
		if(!empty($requiredData))
		{
			...
			{ 
				...
				?>
							...
							if(!empty($requiredDataVal['Retention Goal']))
							{
								echo $agentScoreObj->numberFormat($requiredDataVal['Retention Goal']);
							}
							else
							{
								echo '&nbsp;';	
                            ...
                            <td style="text-align:center;"><?php 
							if(!empty($requiredDataVal['Disenrollment Requests']))
							{
								echo $requiredDataVal['Disenrollment Requests'];
							}
							else
							{
								echo '&nbsp;';	
								...
								?></td>
                            <td style="text-align:center;"><?php 
							if(!empty($requiredDataVal['Saves']))
							{
								echo $requiredDataVal['Saves'];
							}
							else
							{
								echo '&nbsp;';	
                            ...
                            <td style="text-align:center;"><?php 
							if(!empty($requiredDataVal['Missed Saves']))
							{
								echo $requiredDataVal['Missed Saves'];
							}
							else
							{
								echo '&nbsp;';		
							...
							if(!empty($requiredDataVal['Retention']))
							{
								echo $agentScoreObj->numberFormat($requiredDataVal['Retention']);
							}
							else
							{
								echo '&nbsp;';		
