...
<tr>
    ...
    <th class="ColumnHeader1">Care Gaps <br /> Goal</th>
   ...
   <?php 
    ...
    <?php } ?>
    <th class="ColumnHeader1">Care Gap <br />Opportunities</th>
    <th class="ColumnHeader1">Appointments <br />Schedule</th>
    <th class="ColumnHeader1">% Appointments <br />Set</th>
		...
		if(!empty($requiredData))
		{
			...
			{ 
				...
				?>
							...
							<?php 
								if(!empty($requiredDataVal['Care Gaps Goal']))
								{
										echo $requiredDataVal['Care Gaps Goal'];
								}
								else 
								{
										echo '&nbsp;';	
							...
							<td style="text-align:center;">
								<?php 
									if(!empty($requiredDataVal['Opportunities']))
									{
										echo $requiredDataVal['Opportunities'];
									}
									else
									{
										echo '&nbsp;';	
							...
							<td style="text-align:center;">
							<?php 
								if(!empty($requiredDataVal['Appointments Scheduled']))
								{
									echo $requiredDataVal['Appointments Scheduled'];
								}
								else
								{
									echo '&nbsp;';	
							...
							<td style="text-align:center;">
							<?php 
								if(!empty($requiredDataVal['Appointments Set']))
								{
									echo $requiredDataVal['Appointments Set'];
								}
								else
								{
									echo '&nbsp;';	
