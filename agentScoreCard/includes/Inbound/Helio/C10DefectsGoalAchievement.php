...
<tr>
    ...
    <?php } ?>
        ...
        <th class="ColumnHeader1">DEF</th>
        <th class="ColumnHeader1">OPPT</th>
        <th class="ColumnHeader1">C10DS</th>
        <th class="ColumnHeader1">C10DEF</th>
        <th class="ColumnHeader1">C10OPP</th>
        <th class="ColumnHeader1">C10_TARGET</th>
			...
			{ 
				...
				?>
							...
							<td style="text-align:center;"><?php 
                                ...
                                <td style="text-align:center;"><?php 
								echo $requiredDataVal['DEF'];?></td>
							
							<td style="text-align:center;"><?php 
								echo $requiredDataVal['OPPT'];?></td>
                                
                                <td style="text-align:center;"><?php 
								echo $requiredDataVal['C10DS'];?></td>
                                
                                <td style="text-align:center;"><?php 
								echo $requiredDataVal['C10DEF'];?></td>
                                
                                <td style="text-align:center;"><?php 
								echo $requiredDataVal['C10OPP'];?></td>
                                
                                <td style="text-align:center;"><?php 
								echo $requiredDataVal['C10_TARGET'];?></td>
