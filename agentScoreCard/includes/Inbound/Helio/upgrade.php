...
<tr>
    ...
    <?php } ?>
        ...
        <th class="ColumnHeader1">UPG</th>
        <th class="ColumnHeader1">TAKE BACK</th>
        <th class="ColumnHeader1">CALLS HANDLED</th>
         <th class="ColumnHeader1">UPGRADE%</th>
		...
		if(!empty($requiredData))
		{
			...
			{ 
				...
				?>
							...
							<td style="text-align:center;"><?php 
								echo $requiredDataVal['UPG'];?></td>
                                
                                                              
                                <td style="text-align:center;"><?php 
								echo $requiredDataVal['TakeBacks'];?></td>
							
							<td style="text-align:center;"><?php 
								echo $requiredDataVal['CallsHandled'];?></td>
                                
                                <td style="text-align:center;"><?php 
								echo $requiredDataVal['Upgrade'];?></td>
