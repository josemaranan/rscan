...
foreach($requiredData as $rrow)
{
	if($rrow['LOB']==$lob && $rrow['Date']!='Subtotals')
	{
		...
		$ADVN_TOP_BOX[] = $agentScoreObj->numberFormatReturn($rrow['ADVN_TOP_BOX']);
		$ADVN_BTM_BOX[] = $agentScoreObj->numberFormatReturn($rrow['ADVN_BTM_BOX']);
...
$JADVN_TOP_BOX = $agentScoreObj->JsonConvertion($ADVN_TOP_BOX, 'number');
$JADVN_BTM_BOX = $agentScoreObj->JsonConvertion($ADVN_BTM_BOX, 'number');
	...
	$("#LegendTable").append(str);
		...
		var chart;
                ...
                labels: {
					...
					{
						name: 'ADVN TOP BOX', // Dynamic
						//color: '#4E81BD', // Dynamic
						type: 'line',
						yAxis: 0,
						data: <?php echo $JADVN_TOP_BOX;?>
						
					},
					{
						name: 'ADVN BTM BOX', // Dynamic
						//color: '#4E81BD', // Dynamic
						type: 'line',
						yAxis: 0,
						data: <?php echo $JADVN_BTM_BOX;?>
