...
<tr>
   ...
   <th class="ColumnHeader1">Productivity Goal</th>
   <th class="ColumnHeader1">Quality Goal</th>
    ...
    <?php } ?>
    <th class="ColumnHeader1">Fax Hours</th>
    <th class="ColumnHeader1">Number of <br />Faxes Worked</th>
    <th class="ColumnHeader1">Faxes per Hour</th>
		...
		if(!empty($requiredData))
		{
			...
			{ 
				...
				?>
							...
							if(!empty($requiredDataVal['Productivity Goal']))
						   {
							echo $requiredDataVal['Productivity Goal'];
                            }
                            else
							{
								echo '&nbsp';
						   ...
						   {
								if($requiredDataVal['Quality Goal'] == '%')
								{
									echo '&nbsp';
								}
								else
								{
								echo $requiredDataVal['Quality Goal'];
								}
						   }
						   else
						   {
							...
							<td style="text-align:center;"><?php echo $requiredDataVal['Fax Hours'];?></td>
							<td style="text-align:center;"><?php echo $requiredDataVal['Number of Faxes Worked'];?></td>
							<td style="text-align:center;"><?php echo $requiredDataVal['Faxes per Hour'];?></td>
							<td style="text-align:center;"><?php echo $requiredDataVal['Quality'];?></td>
